...
async function testV2Tables() {
  ...
  if (lecErr) {
    console.log('ℹ️ Table video_lectures needs creation or query check:', lecErr.message);
  } else {
  ...
  if (matErr) {
    console.log('ℹ️ Table study_materials needs creation or query check:', matErr.message);
  } else {
  ...
  if (dbtErr) {
    console.log('ℹ️ Table live_class_doubts needs creation or query check:', dbtErr.message);
  } else {
