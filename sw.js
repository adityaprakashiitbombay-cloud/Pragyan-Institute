...
const CACHE_NAME = 'pragyan-portal-v90.0.785fc2df';
...
const PRECACHE_ASSETS = [
  ...
  './features.html',
  './manifest.json',
  './css/variables.css?v=90.0.785fc2df',
  './css/main.css?v=90.0.785fc2df',
  './css/components.css?v=90.0.785fc2df',
  './css/animations.css?v=90.0.785fc2df',
  './css/portal.css?v=90.0.785fc2df',
  './js/stream-community-chat.js?v=90.0.785fc2df',
  './js/blog-markdown.js?v=90.0.785fc2df',
  './js/push-client.js?v=90.0.785fc2df',
  './js/config.js?v=90.0.785fc2df',
  './js/academic-config.js?v=90.0.785fc2df',
  './js/supabase-sync.js?v=90.0.785fc2df',
  './js/chat.js?v=90.0.785fc2df',
  './js/app.js?v=90.0.785fc2df',
  './js/portal.js?v=90.0.785fc2df',
