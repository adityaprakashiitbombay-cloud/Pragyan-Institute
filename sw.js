...
const CACHE_NAME = 'pragyan-portal-v90.0.bf82f65a';
...
const PRECACHE_ASSETS = [
  ...
  './features.html',
  './manifest.json',
  './css/variables.css?v=90.0.bf82f65a',
  './css/main.css?v=90.0.bf82f65a',
  './css/components.css?v=90.0.bf82f65a',
  './css/animations.css?v=90.0.bf82f65a',
  './css/portal.css?v=90.0.bf82f65a',
  './js/stream-community-chat.js?v=90.0.bf82f65a',
  './js/blog-markdown.js?v=90.0.bf82f65a',
  './js/push-client.js?v=90.0.bf82f65a',
  './js/config.js?v=90.0.bf82f65a',
  './js/academic-config.js?v=90.0.bf82f65a',
  './js/supabase-sync.js?v=90.0.bf82f65a',
  './js/chat.js?v=90.0.bf82f65a',
  './js/app.js?v=90.0.bf82f65a',
  './js/portal.js?v=90.0.bf82f65a',
